...
# Define the starting position and moves
...
# Check if the engine found the correct mate-in-1 move
if echo "$ENGINE_OUTPUT" | grep -q "bestmove h5f7"; then
  echo "Engine found mate in 1!"
else
  echo "Engine failed to find mate in 1."
fi